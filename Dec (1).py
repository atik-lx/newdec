...
logo=("""
 ...
 .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. |
| |      __      | ||FB |  _________   | ||FB |     _____    | || |  ___  ____   | |
| |     /  \     | || | |  _   _  |  | || |    |_   _|   | || | |_  ||_  _|  | |
| |    / /\ \    | || | |_/ | | \_|  | |FB| |      | |     | ||PAID |   | |_/ /    | |
| |   / ____ \   | |FB| |     | |      | || |      | |     | || |   |  __'.    | |
| | _/ /    \ \_ | || |    _| |_     | || |     _| |_    | ||FB |  _| |  \ \_  | |
| ||____|  |____|| ATIK|| |   |_____|    | || |    |_____|   | || | |____||____| | |
| |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' 
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("clear")
        os.system("xdg-open https://t.me/bdislmicyber")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am DABIT SULTAN ATIK VAI er  ROBOT and my boss is ATIK.Sir this tool is paid because 100% ok id just now login\"")
